...
charge_temperature = CSV.read("outputs/xiao19_charge_temperature_profiles.csv", DataFrame)
charge_final_temp = charge_temperature[!, Symbol("t_953.0s")]
charge_timeseries_data = CSV.read("outputs/xiao19_charge_timeseries_data.csv", DataFrame)
...
t₀ = 953 # Initial time // s
t_f = 3822 # Final time // s
...
CSV.write("outputs/xiao19_dormant_mass_profiles.csv", mass_df)
...
df_avg_temp = CSV.read("inputs/xiao19_avg_temperature_dormant.csv", DataFrame)
...
output_filename = "outputs/xiao19_dormant_simulation_profiles.svg"
savefig(final_plot, output_filename)
println("\nPlot saved successfully as '$output_filename'")

# Save individuals
savefig(p_temp, "outputs/xiao19_dormant_julia_temperature_profile.svg")
savefig(p_pressure, "outputs/xiao19_dormant_julia_pressure_profile.svg")
savefig(p_mass, "outputs/xiao19_dormant_julia_mass_profiles.svg")
...
CSV.write("outputs/xiao19_dormant_temperature_profiles.csv", df_temp)
...
CSV.write("outputs/xiao19_dormant_adsorption_profiles.csv", df_adsorption)
...
CSV.write("outputs/xiao19_dormant_timeseries_data.csv", df_timeseries)

println("Resultados exportados exitosamente.")

df_simulation_avg_temp = DataFrame(Time=t, Temperature=T_avg)
CSV.write("outputs/xiao19_dormant_avg_temperature.csv", df_simulation_avg_temp)